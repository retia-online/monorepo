// Main exports for @megamercado/configs package
...
// These will be available as: require('@megamercado/configs/tailwind.preset')
// Import TypeScript configs like: require('@megamercado/configs/tsconfig.base.json')