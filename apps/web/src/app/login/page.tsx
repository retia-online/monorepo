...
// Get enabled providers from environment (client side)
const getEnabledProviders = (): string[] => {
    // In client side, we'll check which providers are available
    // This will be passed as props or from an API call
    return ['email', 'google', 'facebook']; // Default, should be dynamic
};
