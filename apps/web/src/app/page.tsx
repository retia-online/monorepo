                    ...
                    <div className="max-w-4xl w-full mx-auto text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                                ...
                                <p className="text-gray-600 text-sm">Acceso inmediato a todas las funcionalidades principales.</p>
                            </div>
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                                ...
                                <p className="text-gray-600 text-sm">Interfaz intuitiva diseñada para una experiencia perfecta.</p>
                            </div>
                        </div>
                    </div>
                </main>
            ...
            <div className="min-h-screen bg-gradient-to-br from-primary/5 to-secondary/5">
                ...
                <main className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] px-4">
                    <div className="max-w-4xl w-full mx-auto text-center">
                        ...
                        <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
                            {session ? (
                                <>Hola <span className="font-semibold text-primary">{session.user?.name}</span>, es genial tenerte de vuelta.</>
                            ) : (
        ...
        <div className="min-h-screen bg-gradient-to-br from-primary/5 to-secondary/5">
            ...
            <main className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] px-4">
                <div className="max-w-4xl w-full mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
                        Has iniciado sesión exitosamente. Disfruta de todas las funcionalidades de la aplicación.
                    </p>
